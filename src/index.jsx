...
import herobg from "./assets/hero_image2.png";
...
const Page = () => {
  return (
    <main className="">
      <section
        id="home"
        className="bg-darkest h-screen py-4 px-3 md:px-24 text-white"
      >
        <Header />
        <section className=" relative block md:flex py-1 justify-between items-center">
          <div className="max-w-md mt-10  ">
            ...
            >
              Fast and secure checkout process for a hassle-free shopping <br />{" "}
            </h1>
            <h1
              style={{ lineHeight: "3.5rem" }}
          ...
          <div className=" md:-top-20  md:-right-10 top-0 relative md:absolute ">
            <img className="md:w-[800px]" src={herobg} alt="hero_inage" />
          </div>
        </section>
      </section>
      <section className="py-4 px-3 md:px-24 bg-secondary">
